...
export const coursesData: CourseType[] = [
  ...
  },
  {
    ...
    title: 'HTML and CSS',
    description: 'Interview Question for HTML and CSS',
    rating: {
      review: 2000,
      star: 4.0,
    },
  ...
  },
  {
    ...
    title: 'React and React Hooks',
    description: 'React and React Hooks Interview Questions',
    rating: {
      review: 2000,
      star: 4.5,
    },
  ...
  },
  {
    ...
    title: 'Power BI',
    description: 'Power BI Interview Questions',
    rating: {
      review: 2000,
      star: 4.5,
    },
...
export const supportRequestsData: SupportRequestsType[] = [
  ...
  {
    name: 'Dennis Barrett',
    description: 'Stackbros assign you a new ticket for Eklav theme',
