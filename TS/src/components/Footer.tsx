      ...
      <Container>
        <Row className="g-4">
          <Col lg={3}>
            ...
            <p className="my-3">
              Eklav education theme, built specifically for the education centers which is dedicated to teaching and involve learners.
            </p>
          ...
          <Col lg={3}>
            ...
            <p className="mb-0">
              Email:<span className="h6 fw-light ms-2">admin@eklav.in</span>
            </p>
          ...
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body text-primary-hover">
                ...
                Copyrights ©{currentYear} Eklav. All rights reserved
