...
const HRInterviewPractice: React.FC<Props> = ({ round, companyName, role, onClose, onAttemptComplete }) => {
  ...
  const handleFinish = () => {
    ...
    const answersPayload: AnswerEntry[] = interviewQuestions.map((q) => ({
      qid: q._id,
      questionText: q.question || q.title || 'HR Interview Question',
            ...
            <>
              ...
              <div className="interview-answer-card">
                ...
                <textarea
                  ...
                  placeholder={speechSupported ? 'Type or click "Speak" to answer with your voice...' : 'Type your response as if you are in a real interview...'}
