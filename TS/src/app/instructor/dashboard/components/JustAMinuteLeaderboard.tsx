...
type JustAMinuteLeaderboardProps = {
  weekKey: string
  college?: string | null
}

const JustAMinuteLeaderboard = ({
  weekKey,
  college,
}: JustAMinuteLeaderboardProps) => {
    ...
    const fetchRanking = async () => {
      try {
        ...
        const res = await fetch(
          `${baseURL}/api/justAMinuteRanking/weekly?${query}`,
          {
            headers: {
...
export default JustAMinuteLeaderboard
