      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="ep-banner-inner">
            ...
            <div className="ep-banner-meta">
              ...
              <div className="ep-banner-chips">
                <span className="ep-chip ep-chip-role">Tutor</span>
        ...
        <div className="ep-body">
          ...
          <div className="ep-section">
            ...
            />
            <div className="ep-upload-zone" onClick={() => document.getElementById('ep-resume-input-tutor')?.click()}>
